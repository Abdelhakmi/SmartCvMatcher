            ...
            <div className="d-flex align-items-center col-12 bg-upload">
              ...
              >
                ...
                <div className="w-100 py-3">
                  <div className="">
                    <textarea
                      className="form-control rounded px-5 py-2 shadow-sm border"
                      rows="4"
...
{
  /* <div className=" UploadDiv d-flex justify-content-between align-items-center">
        <div className="d-flex align-items-center col-12 bg-upload">
          <div
            className="container d-flex flex-column pt-5"
            style={{ maxWidth: "600px", flexGrow: 1 }}
          >
            ...
            <div
              {...getRootProps()}
              className={`border border-2 rounded-4 p-5 text-center w-100 ${
                isDragActive ? "bg-light" : ""
              }`}
              style={{
                background: "#f9f9ff",
